...
if (isset($_SESSION['username']) && isset($_SESSION['level'])) {
	...
	$luongThang = "SELECT ma_luong, hinh_anh, ten_nv, gioi_tinh, ngay_sinh, luong_thang, ngay_cong from luong l, nhanvien nv WHERE l.nhanvien_id = nv.id AND year(ngay_cham) = '$namHienTai' AND month(ngay_cham) = '$thangHienTai' ORDER BY l.id DESC";
