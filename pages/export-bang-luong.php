<?php 
	...
	// PHPExcel
  	...
  	$sheet->setCellValue('G' . $rowCount, 'Ngày chấm công');

  	// do du lieu tu db
  	$sql = "SELECT ma_luong, hinh_anh, nv.id as idNhanVien, ten_nv, ten_chuc_vu, luong_thang, ngay_cong,ngay_cham FROM luong l, nhanvien nv, chuc_vu cv WHERE nv.id = l.nhanvien_id AND nv.chuc_vu_id = cv.id";
  	...
  	while ($row = mysqli_fetch_array($result)) 
  	{
	  	...
	  	$sheet->setCellValue('G' . $rowCount, $row['ngay_cham']);
  	}
