...
if (isset($_SESSION['username']) && isset($_SESSION['level'])) {
  ...
  $kt = "SELECT ktkl.id as id, ma_kt, ten_khen_thuong, ten_nv, ten_loai, so_tien, ktkl.ngay_tao as ngay_tao FROM khen_thuong_ky_luat ktkl, nhanvien nv, loai_khen_thuong_ky_luat lktkl WHERE ktkl.nhanvien_id = nv.id AND ktkl.loai_kt_id = lktkl.id AND ktkl.flag = 1 ORDER BY ktkl.ngay_tao DESC";
  ...
  if (isset($_POST['taoKhenThuong'])) {
    ...
    if (!$error) {
      $showMess = true;
      $insert = "INSERT INTO khen_thuong_ky_luat(ma_kt, nhanvien_id, ten_khen_thuong, loai_kt_id,  so_tien, flag, ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua) VALUES('$maKhenThuong',  '$nhanVien', '$tenKhenThuong', '$loaiKhenThuong', '$soTienThuong', '$flag', '$moTa', '$nguoiTao', '$ngayTao', '$nguoiTao', '$ngayTao')";
      $result = mysqli_query($conn, $insert);
      if ($result) {
